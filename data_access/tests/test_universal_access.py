...
from data_access import universal_data_handler
...
def test_local_access_link_txt_file():
    ...
    error, data = universal_data_handler.put_data(full_link, data_to_file, work_dir=work_dir)
    assert error is None
    assert data_to_file

    error, data_from_file = universal_data_handler.read_data(full_link, work_dir=work_dir)
    assert error is None
